...
Public Sub NoTranparency(forma As Form, color As Long)
On Error Resume Next
Dim RegionActual As Long
 'To Show Full Window Again
 objVideoWindow.WindowStyleEx = -1
 RegionActual = CreateRectRgn(0, 0, Screen.Width / Screen.TwipsPerPixelX, Screen.Height / Screen.TwipsPerPixelY)
 CombineRgn RegionActual, RegionActual, RegionActual, 2
 SetWindowRgn forma.hwnd, RegionActual, True
 DeleteObject (RegionActual)
 objVideoWindow.WindowStyleEx = 1
End Sub
