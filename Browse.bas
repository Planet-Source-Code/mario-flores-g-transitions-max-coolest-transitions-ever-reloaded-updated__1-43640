...
Private Function BrowseCallbackProc(ByVal hwnd As Long, ByVal uMsg As Long, ByVal lp As Long, ByVal pData As Long) As Long
    ...
    Select Case uMsg
        ...
        Case BFFM_SELCHANGED
            ...
            m_CurrentDirectory = Left$(sBuffer, InStr(sBuffer, vbNullChar) - 1)
            
            FrmBrowse.PathChange
    End Select
...
Public Sub ShowTree()
    ...
    FrmBrowse.Show 'load up
    Set DialogContainer = FrmBrowse.PictureBrowse 'container for the Treeview
